...
<body class="bg-gray-100 min-h-screen p-3 sm:p-6">
    <div class="max-w-7xl mx-auto">
        ...
        <!--<div class="bg-gray-900 rounded-xl shadow-lg p-4 sm:p-6 mb-6 sm:mb-8 card-hover border border-gray-700">
            <div class="flex items-center mb-4">
                ...
                <div>
                    <h3 class="text-lg font-semibold text-white">AI Legal Assistant</h3>
            ...
            <div class="flex flex-wrap gap-2 mt-3">
                <span class="text-xs text-gray-400">Quick suggestions:</span>
                <button onclick="setAIQuery('What is the procedure for filing a case in Pakistan?')" class="text-xs bg-gray-700 hover:bg-gray-600 text-gray-200 px-2 py-1 rounded transition duration-200">Filing procedures</button>
                <button onclick="setAIQuery('Explain the difference between civil and criminal law')" class="text-xs bg-gray-700 hover:bg-gray-600 text-gray-200 px-2 py-1 rounded transition duration-200">Civil vs Criminal</button>
                <button onclick="setAIQuery('Latest Supreme Court judgments')" class="text-xs bg-gray-700 hover:bg-gray-600 text-gray-200 px-2 py-1 rounded transition duration-200">Recent judgments</button>
            </div>
        </div>-->
        <!-- AI Assistant Ask Question Button (Centered) -->
        <div
            class="flex flex-col items-center justify-center bg-gray-900 rounded-xl shadow-lg p-5 mb-6 card-hover border border-gray-700">
            <div class="flex flex-col items-center mb-5">
                <div class="bg-themegreen p-2 rounded-lg mb-2">
                    <i class="fas fa-robot text-white text-xl"></i>
                </div>
                <h3 class="text-lg font-semibold text-white text-center">AI Legal Assistant</h3>
                <p class="text-sm text-gray-300 text-center mt-1">Ask any legal question and get instant AI-powered
                    assistance</p>
            </div>
            <button onclick="window.location.href='/my-account/ai-assistant/'"
                class="bg-themegreen hover:bg-themegreenDark text-white font-semibold px-5 py-2 rounded-lg transition duration-200 mb-3"
                ...
                <div class="space-y-6">
                    <div>
                        <div class="flex items-start">
                            ...
                            <div>
                                <h4 class="text-gray-600 text-sm font-extrabold">How often is the database updated?</h4>
                    ...
                    <div>
                        <div class="flex items-start">
                            ...
                            <div>
                                <h4 class="text-gray-600 text-sm font-extrabold">Are historical statutes available?</h4>
                                <p class="text-sm text-gray-600 mt-1">Yes, we maintain comprehensive archives of current
    ...
    function handleAISearch() {
        ...
        if (query) {
            // Redirect to AI Assistant page with the query and auto-submit flag
            window.location.href = `/my-account/ai-assistant.php?q=${encodeURIComponent(query)}&autosubmit=1`;
        } else {
            // If empty, just go to AI Assistant page
    ...
    document.addEventListener("DOMContentLoaded", () => {
        const quickButtons = document.querySelectorAll(
            ".flex.flex-wrap.gap-2.justify-center.mt-1 button"
        );
